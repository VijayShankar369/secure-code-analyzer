"""
Simplified JavaScript parser that works without complex tree-sitter queries.
"""
...
class JavaScriptParser:
    """Simplified JavaScript parser for basic pattern matching."""
    ...
    def is_supported_file(self, file_path: Path) -> bool:
        ...
        return file_path.suffix.lower() in [".js", ".mjs", ".jsx", ".ts", ".tsx"]
